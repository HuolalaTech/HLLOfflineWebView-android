...
import com.lalamove.huolala.offline.webview.download.FileDownLoadHelper;
...
//                        .requestServer(new DefaultRequest())
                        ...
                        .monitor(new IEnhWebMonitor() {
                            ...
                            @Override
                            public void monitorSummary(String name, float value, HashMap<String, String> labelMap, String extra) {
    ...
    private void doDownloadBySDK(String url, String phoneDir, String fileName, IDownLoader.DownloadCallback callback) {
        com.lalamove.huolala.offline.webview.download.FileDownLoadHelper fileDownLoadHelper = new com.lalamove.huolala.offline.webview.download.FileDownLoadHelper();
